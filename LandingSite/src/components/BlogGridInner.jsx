    ...
    <div className='blog-page-section py-120'>
      <div className='container'>
        <div className='flex-between gap-16 flex-wrap mb-40'>
          {/* <span className='text-neutral-500'>Showing 9 of 13 Results </span> */}
              ...
              <div className='pt-32 pb-24 px-16 position-relative'>
                ...
                <div className='flex-align gap-14 flex-wrap my-20'>
                  <div className='flex-align gap-8'>
                    ...
                    <span className='text-neutral-500 text-lg'>By B.Dandane</span>
                  </div>
              ...
              <div className='pt-32 pb-24 px-16 position-relative'>
                ...
                <div className='flex-align gap-14 flex-wrap my-20'>
                  <div className='flex-align gap-8'>
                    ...
                    <span className='text-neutral-500 text-lg'>By Z.Chbani</span>
                  </div>
                  <span className='w-8 h-8 bg-neutral-100 rounded-circle' />
                  <div className='flex-align gap-8'>
                    <span className='text-neutral-500 text-2xl d-flex'>
              ...
              <div className='pt-32 pb-24 px-16 position-relative'>
                ...
                <div className='flex-align gap-14 flex-wrap my-20'>
                  ...
                  <div className='flex-align gap-8'>
                    ...
                    <span className='text-neutral-500 text-lg'>1.5k</span>
                  </div>
                  {/* <span className='w-8 h-8 bg-neutral-100 rounded-circle' />
                  <div className='flex-align gap-8'>
                    <span className='text-neutral-500 text-2xl d-flex'>
