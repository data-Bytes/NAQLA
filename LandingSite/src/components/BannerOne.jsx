        ...
        <div className='row gy-5 align-items-center'>
          <div className='col-xl-6'>
            <div className='banner-content pe-md-4'>
              ...
              <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                Empowering students to excel academically, grow in faith, 
                and build the skills for tomorrow — all in one engaging online platform.
              </p>
          ...
          <div className='col-xl-6'>
            <div className='banner-thumb position-relative'>
              <img
                src='assets/images/thumbs/boy.jpg'
                alt=''
