...
const CounterOne = () => {
  ...
  {({ isVisible }) => (
    <h2 className='display-four mb-16 text-neutral-700 counter'>
      <CountUp start={0} end={isVisible ? 100 : 0} duration={2} />+
    </h2>
  )}
</VisibilitySensor>
              <span className='text-neutral-500 text-lg'>
                Learning Hours Created
              </span>
            </div>
          </div>
          <div
  ...
  {({ isVisible }) => (
    <h2 className='display-four mb-16 text-neutral-700 counter'>
      <CountUp start={0} end={isVisible ? 600 : 0} duration={2} />+
    </h2>
  )}
</VisibilitySensor>
              <span className='text-neutral-500 text-lg'>
  ...
  {({ isVisible }) => (
    <h2 className='display-four mb-16 text-neutral-700 counter'>
      <CountUp start={0} end={isVisible ? 95 : 0} duration={2} />%
    </h2>
  )}
</VisibilitySensor>
              <span className='text-neutral-500 text-lg'>
  ...
  {({ isVisible }) => (
    <h2 className='display-four mb-16 text-neutral-700 counter'>
      <CountUp start={0} end={isVisible ? 20 : 0} duration={2} />K+
    </h2>
  )}
</VisibilitySensor>
              <span className='text-neutral-500 text-lg'>
