    ...
    <section className='instructor py-120 bg-main-25 position-relative z-1'>
      ...
      <div className='container'>
        <div className='section-heading text-center'>
          <h2 className='mb-24 wow bounceIn'>Our Instructors</h2>
          <p className=' wow bounceInUp'>
            Meet the educators and mentors behind Naqla. Each of them brings expertise, warmth, and a shared vision: helping every student grow in knowledge, confidence, and values.
          </p>
        </div>
        <Slider
          {...settings}
            ...
            <div className='rounded-12 overflow-hidden position-relative bg-dark-yellow'>
              ...
              >
                <img
                  ...
                  className='scale-hover-item__img rounded-6 cover-img transition-2'
                />
              </Link>
            </div>
            <div className='p-24 position-relative'>
              <div className=''>
                <h4 className='mb-28 pb-24 border-bottom border-neutral-50 mb-24 border-dashed border-0'>
                  <Link href={`/instructor-details/${instructor.id}`} className='link text-line-2'>
                    {instructor.name}
                  </Link>
                </h4>
                  ...
                  <div className='flex-align gap-4'>
                    ...
                    <span className='text-lg text-neutral-700'>
                     {instructor.avgRating}
                      <span className='text-neutral-100'>(472)</span>
                    </span>
                  </div>
                </div>
              </div>
